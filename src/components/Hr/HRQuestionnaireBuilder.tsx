...
const HRQuestionnaireBuilder = () => {
  ...
  const [filteredQuestionnaires, setFilteredQuestionnaires] = useState<HrQuestionnaire[]>([]);
  ...
  const [editingQuestionnaire, setEditingQuestionnaire] = useState<HrQuestionnaire | null>(null);
  const [selectedQuestionnaire, setSelectedQuestionnaire] = useState<HrQuestionnaire | null>(null);
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (response.data.data.failed && response.data.data.failed.length > 0) {
          setTimeout(() => {
            response.data.data.failed.forEach((failure: { candidate: string; error: string }) => {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">HR Questionnaire Builder</h1>
                    ...
                    <TableRow
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          <Avatar>
                            <AvatarImage src={questionnaire.candidate.profile_photo_url?.url} />
                            <AvatarFallback>
                              {questionnaire.candidate.first_name[0]}{questionnaire.candidate.last_name[0]}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          ...
                          {questionnaire.assigned_questions.length > 2 && (
                            <Badge variant="outline" className="text-xs">
                              +{questionnaire.assigned_questions.length - 2} more
                            </Badge>
                          )}
                        </div>
                      </TableCell>}
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex items-center space-x-3">
                        <Avatar>
                          ...
                          <AvatarFallback>
                            {editingQuestionnaire.candidate.first_name[0]}{editingQuestionnaire.candidate.last_name[0]}
                          </AvatarFallback>
                        </Avatar>
                        <div>
                          <div className="font-medium">
                            {editingQuestionnaire.candidate.first_name} {editingQuestionnaire.candidate.last_name}
                          </div>
                          <div className="text-sm text-muted-foreground">
          ...
          {selectedQuestionnaire && (
            <ScrollArea className="flex-1 pr-4">
              <div className="space-y-6">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold">
                          {selectedQuestionnaire.candidate.first_name} {selectedQuestionnaire.candidate.last_name}
                        </h3>
                        <p className="text-muted-foreground">{selectedQuestionnaire.candidate.email}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Assigned Questions ({selectedQuestionnaire.assigned_questions.length})</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="font-medium">{selectedQuestionnaire.assigned_by.name}</p>
