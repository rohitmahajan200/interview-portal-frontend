...
const Settings = () => {
  ...
  },
  {
    ...
    svg:<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-cloud-download-icon lucide-cloud-download"><path d="M12 13v8l-4-4"/><path d="m12 21 4-4"/><path d="M4.393 15.269A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.436 8.284"/></svg>,
    onClick: () => {
      console.log("Download personal info clicked");
    },
  },
  {
      ...
      <div className="space-y-6 max-w-2xl mx-auto">
        {settingsOptions.map((option, index) => (
          ...
          >
            ...
            <Button className="mt-4 sm:mt-0 hover:cursor-pointer" onClick={option.onClick}>
              {option.actionLabel}
              {option?.svg}
            </Button>
          </div>
